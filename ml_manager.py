...
class MLManager:
    ...
    @staticmethod
    def train_model_get_specs(model: GenericMLModel, data_container: DataContainer, nr_of_epochs: int) \
        ...
        for it in range(0, nr_of_epochs):
            ...
            current_specs = MLManager.get_specs(model, data_container.get_validation_set())
